...
public class NamedParameterStatement {
    ...
    public NamedParameterStatement(DataSource dataSource, String query) {
        this(dataSource, Statement.NO_GENERATED_KEYS, query);
    }

    /**
     * Initialize statement
     */
    public NamedParameterStatement(DataSource dataSource, int autoGeneratedKeys, String query) {
    ...
    public void reset(boolean resetConnection) throws SQLException {
        ...
        if (resetConnection && connection != null) {
            connection.close();
            connection = null;
        }
        if (connection == null) {
